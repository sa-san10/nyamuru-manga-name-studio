...
const STEPS: {
  ...
  },
  {
    number: '3',
    title: '画像生成AIで漫画にする',
    tool: '「生成ワークフロー」タブのワークフロー ＋ 「生成プロンプト」タブの画像生成指示（OMAY） ＋ キャラ・背景のリファレンス画像 ＋ 画像生成できるAIエージェント（GPT Workなど）',
    tasks: [
      '「生成ワークフロー」タブのワークフローと画像生成指示（OMAY）を、エージェントが参照できる場所に配置してプロジェクト指示を設定する（初回のみ。以降の作品はOMNYを渡すだけ）',
