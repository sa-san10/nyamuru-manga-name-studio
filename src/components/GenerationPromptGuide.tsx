...
export default function GenerationPromptGuide({ lang, onChangeLang, onNotify }: Props) {
  ...
  return <DownloadableMarkdownGuide
    ...
    description={en
      ? 'The full prompt (written in Japanese) that structures a story manuscript into NDM v10.2 and outputs it in OMNY format.'
      : 'ストーリー原稿をNDM v10.2へ構造化し、OMNY形式で出力するための完全版プロンプトです。'}
