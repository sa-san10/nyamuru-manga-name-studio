...
export default function App() {
  ...
  useEffect(() => {
    try {
      const firstVisit = !localStorage.getItem(HOWTO_INTRO_KEY);
      if (firstVisit) {
