...
export default function SchemaGuide({ lang, onChangeLang, onNotify }: Props) {
  ...
  return <div class="document-editor">
    <div class="document-editor-head">
      <div><span class="eyebrow">Nyamuru🐱 · NDM v10</span><h2>Nyamuru Data Model</h2><p>{en ? 'The NDM specification and how it serializes to OMNY, in Markdown.' : 'NDMの仕様とOMNY形式へのシリアライズ方法をMarkdownで確認できます。'}</p></div>
